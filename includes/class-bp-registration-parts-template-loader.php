...
/**
 * Template loader for BP Registration Parts.
 *
 ...
 */
class BP_Registration_Parts_Template_Loader extends Gamajo_Template_Loader {
  /**
   ...
   * @var string
   */
  protected $theme_template_directory = 'bp-resgitration-parts';
   ...
   * @var string
   */
  protected $plugin_directory = BPRP_PLUGIN_DIR;
